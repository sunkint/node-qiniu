...
function PutPolicy(opts) {
  ...
  // 补充七牛上传凭证的其他选项
  this.isPrefixalScope = _.isNumber(opts.isPrefixalScope) ? opts.isPrefixalScope : null;
  this.insertOnly = _.isNumber(opts.insertOnly) ? opts.insertOnly : null;
  this.callbackHost = opts.callbackHost || null;
  this.callbackBodyType = opts.callbackBodyType || null;
  this.persistentOps = opts.persistentOps || null;
  this.persistentNotifyUrl = opts.persistentNotifyUrl || null;
  this.persistentPipeline = opts.persistentPipeline || null;
  this.forceSaveKey = _.isBoolean(opts.forceSaveKey) ? opts.forceSaveKey : null;
  this.saveKey = opts.saveKey || null;
  this.fsizeMin = opts.fsizeMin || null;
  this.fsizeLimit = opts.fsizeLimit || null;
  this.detectMime = _.isNumber(opts.detectMime) ? opts.detectMime : null;
  this.mimeLimit = opts.mimeLimit || null;
  this.fileType = _.isNumber(opts.fileType) ? opts.fileType : null;
}
